...
{	
	...
	document.write('<ul>');
	document.write('<li><a href="http://homepages.ulb.ac.be/~vfisikop/data/resultant.html" ', current1,'>resultant</a></li>');
	document.write('<li><a href="http://homepages.ulb.ac.be/~vfisikop/data/2-level.html" ', current2, '>2-level</a></li>');
	document.write('</ul>');
